public class Student
{
   ...
   public Student( String firstName, String lastName, long StudentNo, int day, int month, int year) { // constructor with parameter and a set of values in curly braces
...
//   }
   ...
   public String MakeStringForCSV() {  // create to export easier for child class (Student_Common and Student Major can use with super)
